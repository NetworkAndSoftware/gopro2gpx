...
#if 1
  size_t mp4 =
      OpenMP4Source(argv[1], MOV_GPMF_TRAK_TYPE, MOV_GPMF_TRAK_SUBTYPE);
#else
  size_t mp4 =
      OpenMP4SourceUDTA(argv[1]); // Search for GPMF payload with MP4's udta
#endif
  if (mp4 == 0) {
